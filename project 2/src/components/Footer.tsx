        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm">
              Find your perfect neighborhood with our comprehensive platform for discovering, comparing, and reviewing communities.
            </p>
            <div className="flex space-x-4">
              <div className="flex items-center space-x-2 text-sm text-gray-400">
                <Mail className="h-4 w-4" />
                <span>hello@neighborfit.com</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/compare" className="text-gray-400 hover:text-white text-sm transition-colors">
                  Compare Areas
                </Link>
              </li>
              <li>
